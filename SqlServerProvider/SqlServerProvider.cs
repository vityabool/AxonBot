...
namespace AxonPartners.DAL
{
    ...
    {
        private const string SqlDbConnectionString = "Server=tcp:axon-srv.database.windows.net,1433;Initial Catalog=axonDb;Persist Security Info=False;User ID=axonadmin;Password=;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
